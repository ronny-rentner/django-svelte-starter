...
- Check modern forks of `sbd` for Markdown index sentence splitting. `sbd` handles the current abbreviation cases better than `Intl.Segmenter` and `sentence-splitter`, but it has not changed in years.
